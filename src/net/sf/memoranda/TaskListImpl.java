...
public class TaskListImpl implements TaskList {
    ...
    public Task createTask(CalendarDate startDate, CalendarDate endDate, String text, int priority, long effort, int codeLines, String description, String parentTaskId) {
        ...
        el.addAttribute(new Attribute("codeLines", String.valueOf(codeLines)));
